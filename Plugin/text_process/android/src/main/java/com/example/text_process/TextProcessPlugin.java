...
/** TextProcessPlugin */
public class TextProcessPlugin implements FlutterPlugin, ActivityAware {

  // Plugin Constructor
  public TextProcessPlugin() {}
  ...
  public static void setUserInitialization(boolean showConfirmationToast, boolean showRefreshToast,
    ...
    TextProcessPlugin.showConfirmationToast = showConfirmationToast;
    TextProcessPlugin.showRefreshToast = showRefreshToast;
    TextProcessPlugin.showErrorToast = showErrorToast;
    TextProcessPlugin.confirmationMessage = confirmationMessage;
    TextProcessPlugin.refreshMessage = refreshMessage;
    TextProcessPlugin.errorMessage = errorMessage;
  }
  /* ------------- User Initialization -------------- */
  ...
  public static void setSavedProcessIntentText(String savedProcessIntentText) {
    TextProcessPlugin.savedProcessIntentText = savedProcessIntentText;
  }
  /* ------------- Saved Process Text -------------- */
  ...
  private void setupChannel(BinaryMessenger messenger, Context context, Activity activity) {
    TextProcessPlugin.activity = activity;
...
//    eventChannel = new EventChannel(binaryMessenger,STREAM_ID);
    ...
    eventChannel = new EventChannel(messenger,STREAM_ID);
  ...
  public static void registerWith(io.flutter.plugin.common.PluginRegistry.Registrar registrar) {
    final TextProcessPlugin plugin = new TextProcessPlugin();
  ...
  public static void openApp() {
    TextProcessPlugin.saveProcessIntentText();
